...
IFlowReconcileListener, IInfoProvider, IHAListener {
    ...
    protected Device learnDeviceByEntity(Entity entity) {
        ...
        while (true) {
            ...
            if (deviceKey != null) {
                ...
                System.out.println("learnDeviceByEntity  with mac= "+entity.macAddress+" ip= "+entity.ipv4Address+" switch= "+entity.switchPort+ " port= "+entity.switchPort);
                // update indices
    ...
    private void updateSecondaryIndices(Entity entity,
                                        ...
                                        Long deviceKey) {
    	System.out.println("updateSecondaryIndices");
    ...
    protected void cleanupEntities () {
        ...
        while (diter.hasNext()) {
            ...
            while (true) {
                ...
                toRemove.clear();
                toKeep.clear();
                logger.debug("All entries are Cleared in Device Manager");
